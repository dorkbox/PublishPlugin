...
object LicenseFilesFixup {
    fun Project.fixupLicenseFiles() {
        // Include license files in sources and in jar!
        val files = projectDir.listFiles().filter { it.name.startsWith("LICENSE.") }
